...
#################### Load metadata #################### 
samples = read.table("/data/class/ecoevo283/erebboah/RNAseq/prefixes_random.txt",header=FALSE)
samples = samples$V1
...
write.table(counts, file="/data/class/ecoevo283/erebboah/RNAseq/counts/counts_100samples_flybaseIDs.tsv", quote=F)
